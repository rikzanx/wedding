...
<!----------nav------>
    ...
    <div class="container">
    <h1 class="display-6"><center> DAFTAR PAKET PERNIKAHAN</center></h1>
    </div>
    </div>
    <div class="container"  >
    <div class="btn-group" role="group" aria-label="Basic example">
    <p><a href="tambahdatapaket.php" class="btn btn-info ">Tambah data</a></p>
    </div>
  ...
  <tbody>
    <?php
        ...
        <tr>
            ...
            <td><?php echo rupiah ($baris['harga'])?></td> 
            <td><?php echo $baris['keterangan']?></td> 
            <td><?php echo $baris['tipe']?></td> 
            <td><?php echo $baris['jumlah_tamu']?></td> 


            <td>
                <a href="updatepaket.php?id_paket=<?php echo $baris['id_paket']?>" 
                class="btn btn-info"><i class="bi bi-pencil-square"></i> Update</a>
                <a href="deletedatapaket.php?id_paket=<?php echo $baris['id_paket']?>"

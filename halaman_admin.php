  ...
  <a class="navbar-brand font-Dishonorable Mention" >Halo, <?php echo $_SESSION['username']; ?> </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <li class="nav-item ml-auto">
          <a class="nav-link" href="#menuadmin">Admin Panel    |</a>
        </li>
        <li class="nav-item ml-auto">
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <h3 class="card-text"><i class="bi bi-cash-coin"></i></h3><br>
        <a href="listtransaksiadmin.php" class="btn btn-primary">Lihat Data</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <h3 class="card-text"><i class="bi bi-bag-check-fill"></i></h3><br>
        <a href="listpesananadmin.php" class="btn btn-primary">Lihat Data</a>
      </div>
    </div>
  </div>
</div><br>
<div class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Kelola Akun Pengguna</h5>
        <h3 class="card-text"><i class="bi bi-person-circle"></i></h3><br>
        <a href="readkelolaakun.php" class="btn btn-primary">Lihat Data</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Kelola Paket WO</h5>
        <h3 class="card-text"><i class="bi bi-gem"></i></h3><br>
        <a href="kelolapaketadmin.php" class="btn btn-primary">Lihat Data</a>
      </div>
    </div>
  </div>
</div>

...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="col-sm-6">
    <div class="card ">
    <h4 class="card-header text-center">Update Akun</h4>
    <div class="card-body card-center">
      <div class="card-body">
      <form action="cek_updateakun.php?id_user=<?php echo $id_user ?>" method="post">
      <label for="id_user">ID USER </label>
        <input type="text" name="id_user" id="id_user" class="form-control " value="<?php echo $id_user ?>"><br>
      <label for="nama_lengkap">Nama lengkap</label>
        ...
        <label for="text">Hak akses</label><br>

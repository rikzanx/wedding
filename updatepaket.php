...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="col-sm-6">
    <div class="card ">
    <h4 class="card-header text-center">Update Paket WO</h4>
    <div class="card-body card-center">
      <div class="card-body">
      <form action="cek_updatepaket.php?id_paket=<?php echo $id_paket ?>" method="post">
      <label for="id_paket">ID PAKET <?php echo $id_paket ?></label>
...
header('location:updatepaket.php');
}
?>
 <?php
if (isset($_POST['submit'])) {
